...
const lines = [
  ...
  '      }',
  '      await client.query(',
  "        'INSERT INTO error_tags (attempt_id, question_id, error_tag, updated_at) VALUES ($1, $2, $3, now()) ON CONFLICT (attempt_id, question_id) DO UPDATE SET error_tag = EXCLUDED.error_tag, updated_at = now()',",
...
s = s.slice(0, idx) + lines + s.slice(idx);
fs.writeFileSync(file, s, 'utf8');
console.log('inserted endpoints before app.use 404');
